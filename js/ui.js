...
let actionButtonsHtml = `
    <div class="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
        <button onclick="event.stopPropagation(); togglePause(${task.id})" class="text-navy-400 hover:text-brand-500 p-1.5 rounded hover:bg-navy-700 transition-colors focus:outline-none" title="Pausar/Reanudar">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 9v6m4-6v6m7-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
        </button>
        <button onclick="event.stopPropagation(); addSubtask(${task.id})" class="text-navy-400 hover:text-brand-500 p-1.5 rounded hover:bg-navy-700 transition-colors focus:outline-none" title="Agregar Subtarea">
        ...
        <button onclick="event.stopPropagation(); deleteTask(${task.id})" class="text-navy-400 hover:text-danger-500 p-1.5 rounded hover:bg-navy-700 transition-colors focus:outline-none" title="Eliminar">

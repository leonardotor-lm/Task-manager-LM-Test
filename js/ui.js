...
let actionButtonsHtml = `
    <div class="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
        <button onclick="event.stopPropagation(); toggleProgressNative(${task.id})" class="text-navy-400 hover:text-brand-500 p-1.5 rounded hover:bg-navy-700 transition-colors focus:outline-none" title="Pausar/Reanudar">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 9v6m4-6v6m7-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
        </button>
        <button onclick="event.stopPropagation(); prepareSubtaskNative(${task.id})" class="text-navy-400 hover:text-brand-500 p-1.5 rounded hover:bg-navy-700 transition-colors focus:outline-none" title="Agregar Subtarea">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
        </button>
        <button onclick="event.stopPropagation(); openPostponeModal(${task.id})" class="text-navy-400 hover:text-brand-500 p-1.5 rounded hover:bg-navy-700 transition-colors focus:outline-none" title="Posponer">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
        </button>
        <button onclick="event.stopPropagation(); openEditModal(${task.id})" class="text-navy-400 hover:text-brand-500 p-1.5 rounded hover:bg-navy-700 transition-colors focus:outline-none" title="Editar">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/></svg>
        </button>
        <button onclick="event.stopPropagation(); deleteTaskUniversal(${task.id})" class="text-navy-400 hover:text-danger-500 p-1.5 rounded hover:bg-navy-700 transition-colors focus:outline-none" title="Eliminar">
